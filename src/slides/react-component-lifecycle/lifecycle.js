    ...
    return (
      <Slide bgColor="primary" transition={['slide']} {...this.props}>
        ...
        <Text textSize="32" textColor="white">
          Events that fire throughout the lifecycle of a component. There are events for:
        </Text>
        <List>
...
const DerivedStateSlide = ListSlideMaker(`getDerivedStateFromProps (props, state)`, [
...
const ShouldUpdateSlide = ListSlideMaker(`shouldComponentUpdate (nextProps, nextState)`, [
...
const DidUpdateSlide = ListSlideMaker(`componentDidUpdate (previousProps, PreviousState)`, [
  ...
  render() {
    return (
      <Slide bgColor="primary" transition={['slide']} {...this.props}>
        ...
        <List>
          <ListItem textSize="32" margin="0 0 1.5rem 0">
            <Link href="https://reactjs.org/docs/react-component.html">Documentation for all lifecycle methods</Link>
          </ListItem>
          <ListItem textSize="32" margin="0 0 1.5rem 0">
