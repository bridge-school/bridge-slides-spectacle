...
const Slide2 = ListSlideMaker(
  ...
  `Mixing mutation and asynchronicity is difficult to reason about. Redux tries to make state mutations predictable`]
);
